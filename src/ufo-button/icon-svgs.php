<?php
// Auto-generated by scripts/generate-icon-svgs.js — do not edit manually.
// Re-generate: node scripts/generate-icon-svgs.js

if ( function_exists( 'ufo_get_icon_svg' ) ) {
    return;
}

function ufo_get_icon_svg( $name, $class = '' ) {
    static $icons = null;
    if ( null === $icons ) {
        $icons = [
