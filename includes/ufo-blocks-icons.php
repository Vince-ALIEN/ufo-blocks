...
if ( ! function_exists( 'ufo_get_icon_svg' ) ) :
	...
	function ufo_get_icon_svg( string $icon_name, string $classes = '', int $size = 24 ): string {
		...
		static $paths = [
			'AlarmClockPlus'        => '<circle cx="12" cy="13" r="8"></circle><path d="M5 3 2 6"></path><path d="m22 6-3-3"></path><path d="M6.38 18.7 4 21"></path><path d="M17.64 18.67 20 21"></path><path d="M12 10v6"></path><path d="M9 13h6"></path>',
			...
			'HardDriveDownload'     => '<path d="M12 2v8"></path><path d="m16 6-4 4-4-4"></path><rect width="20" height="8" x="2" y="14" rx="2"></rect><path d="M6 18h.01"></path><path d="M10 18h.01"></path>',
			...
			'MessageCirclePlus'     => '<path d="M2.992 16.342a2 2 0 0 1 .094 1.167l-1.065 3.29a1 1 0 0 0 1.236 1.168l3.413-.998a2 2 0 0 1 1.099.092 10 10 0 1 0-4.777-4.719"></path><path d="M8 12h8"></path><path d="M12 8v8"></path>',
			...
			'MoveRight'             => '<path d="M18 8L22 12L18 16"></path><path d="M2 12H22"></path>',
			'MoveUpRight'           => '<path d="M13 5H19V11"></path><path d="M19 5L5 19"></path>',
			...
			'SquareArrowOutUpRight' => '<path d="M21 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h6"></path><path d="m21 3-9 9"></path><path d="M15 3h6v6"></path>',
